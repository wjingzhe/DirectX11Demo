...
PostProcess::ScreenBlendRender::ScreenBlendRender():BasePostProcessRender(), m_pBlendTextureSRV(nullptr)
{
...
void PostProcess::ScreenBlendRender::ReleaseSwapChainAssociatedCOM(void)
{
	SAFE_RELEASE(m_pBlendTextureSRV);

	BasePostProcessRender::ReleaseSwapChainAssociatedCOM();
}
